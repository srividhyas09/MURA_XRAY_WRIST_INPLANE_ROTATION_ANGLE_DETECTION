...
if __name__ == '__main__':
    # load sample image
    #data_transform_augment = transforms.Compose([Crop(), Rescale((128, 128)), ToTensor()])
    data_transform_augment = transforms.Compose([Crop(), Resize(), Rescale((250, 250)), Normalization(), ToTensor()])
